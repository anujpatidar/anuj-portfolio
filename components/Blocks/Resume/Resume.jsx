                    ...
                    <div className={styles.cardGroup} ref={cardGroup}>
                        <div className={`${styles.card} ${styles.cardV1}`}>
                            <div className={styles.cardInner}>
                                <div className={styles.cardTitle}>Anuj Patidar</div>
                                <hr/>
                                <p>Innovative FullStack developer, skillfull at independent projects, with good accent on website development. I am curently looking for an opportunity to work in an environment that will help me to progress for my future goals which is as developer.
                                </p>
                                <div >
                                ...
                                <p>
                                    Bachelors in Technology | LNCT Bhopal <br/>
                                    12th Standard | Sita Devi H.S. School <br/>
                                    10th Standard | Keshav International School
                                </p>
                            </div>
                            <figure className={styles.figure}>
                                <Image src="/anuj.jpg" alt="Anuj Patidar" width={150} height={150}/>
                            </figure>
                        </div>
