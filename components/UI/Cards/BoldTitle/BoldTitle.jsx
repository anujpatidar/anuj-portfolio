        ...
        <section className={styles.section}>
            <Container className={styles.grid}>
                <TextReveal className={styles.paragraph}>
                    I have a keen eye for UI design, enabling me to understand designs well and foster effective communication.
                </TextReveal>
                ...
                <TextReveal className={`${styles.paragraph} ${styles.paragraphAlt}`}>
                    Currently, I live in Bhopal. In my personal life, I love to do Cinematography while travelling to different locations.
                </TextReveal>
